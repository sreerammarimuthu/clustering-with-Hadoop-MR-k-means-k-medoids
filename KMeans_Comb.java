...
public class KMeans_Comb {
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputPath = "C://Users//user//Downloads//Output_Task_2d_k7";
        ...
        job.setJarByClass(KMeans_Comb.class);
        job.setMapperClass(KMeans_Comb.KMeansMapper.class);
        job.setCombinerClass(KMeansCombiner.class); // Use the combiner
        job.setReducerClass(KMeans_Comb.KMeansReducer.class);
