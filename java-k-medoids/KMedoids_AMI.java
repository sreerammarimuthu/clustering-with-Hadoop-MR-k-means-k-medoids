...
public class KMedoids_AMI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputPath = "C://Users//user//Downloads//Output_Task_3c_k777";
        ...
        List<KMedoids_AMI.Medoid> allMedoids = new ArrayList<>();
        try (BufferedReader br = new BufferedReader(new FileReader(medoidInputPath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                double x = Double.parseDouble(parts[0]);
                double y = Double.parseDouble(parts[1]);
                allMedoids.add(new KMedoids_AMI.Medoid(id, new KMedoids_AMI.Point(x, y)));
                id++;
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        job.setJarByClass(KMedoids_AMI.class);
